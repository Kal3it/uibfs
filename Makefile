...
PROGRAMS=mi_mkfs leer_sf mi_escribir mi_cat truncar permitir mi_mkdir mi_touch mi_chmod mi_ls mi_stat mi_cp mi_link mi_rm mi_mv simulacion verificacion
OBJS=$(SOURCES:.c=.o)
